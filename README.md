...
Reference tables for Siraya (西拉雅語), a Formosan Austronesian language, based on Adelaar (2011).
...
## Affixes — alphabetical reference

Complete list of prefixes, suffixes, infixes, circumfixes, and clitics, sorted alphabetically by affix form.
...
## Free-form grammatical words — alphabetical reference

Complete list of free-form grammatical words (tense, mood, case markers, discourse particles, etc.), sorted alphabetically by form.
...
## Glossing markers → surface affix forms

Mapping from glossing labels to their surface morphological forms.
